...
// 交割合约
import regular from './en/regular.js'
let EN = {
  common: {
  ...
  productInfo: {
    ...
    lowPrice: 'Low',
    fundingRate: 'Rate',
    prompt: 'If the funding rate is within ±0.03%, there will be no payment exchange between the longs and the shorts.'
  },
  // 委托
  createdEntrust: {
    ...
    positions: 'Positions',
    lot: 'Lot',
    leverageInfo: "Leverage: Currently multiple leverages are available. High leverage involves high risk, please be cautious.\n",
    ...
    A_sell: 'Sell to Open',
    A_limit: 'Limit Order',
    A_buy_title: 'Buy <span style="color:{color};">{num}</span> Lot {name} Contract(s)',
    A_sell_title: 'Sell <span style="color:{color};">{num}</span> Lot {name} Contract(s)',
    A_buy_flat: 'Buy to Close',
    A_sell_flat: 'Sell to Close',
    marketInfo: 'Market price: To prevent misoperation and reduce user’s losses, the market order will be executed at ±3% of the index price, any price exceeds this range will not be filled.\n',
    ...
    hand: 'Contract Size (Contract): The contract size refers to the amount of the underlying asset covered by each contract traded on the exchange.<span style="display: block">e.g.: 1 {hand} {name} = {value}{tableName}</span>',
    explosion: 'This price may result in liquidation, please check whether you have an order or not, if yes, please set a reasonable order price.',
  ...
  asset: {
    ...
    riskDegreeInfo: 'When the risk level = 100%, your account will enter the liquidation process. Please pay attention to the risk level.',
  ...
  transactionList: {
    ...
    elpTips2: 'This estimated price does not mean the real liquidation price. It is only for reference.',
    elpTips3: 'For multi-currency positions, only the liquidation prices for all currencies are met simultaneously can the liquidation be triggered. The system will not liquidate single currency positions under multi-currency positions.',
    strongParity: 'ELP',
    ...
    prompt: 'This action only supports market order (for available positions), which may involve great risk, please be aware! ',
    currency: 'Currency',
    openLeve: 'Open/Close',
