    ...
    <div class="content">
      ...
      <div class="container">
        ...
        <st-row class="info">
          ...
          <!-- 正常下单 -->
          <st-row class="item" direction="column">
            <p :style="{color: utils.splitFormat(utils.editE(utils.mul(walletAsset.risk || 0, 100)), 0) > 50 ? '#E12961' : '#0AB480'}">{{ utils.splitFormat(utils.editE(utils.mul(walletAsset.risk || 0, 100)), 0) }}%</p>
