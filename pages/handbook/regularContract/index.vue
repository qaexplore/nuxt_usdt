  ...
  <div class="fund" id="test">
    <div class="text-content">
      ...
      <h3
        ...
        class="title"
        name="1"
      >{{ $t('message.regular.navigation.regularThirdTitle1') }}</h3>
      ...
      <h3
        ...
        class="title"
        name="2"
      >{{ $t('message.regular.navigation.regularThirdTitle2') }}？</h3>
      ...
      <h3
        ...
        class="title"
        name="3"
      >{{ $t('message.regular.navigation.regularThirdTitle3') }}</h3>
      ...
      <h3
        ...
        class="title"
        name="4"
      >{{ $t('message.regular.navigation.regularThirdTitle4') }}</h3>
      ...
      <h3
        ...
        class="title"
        name="5"
      >{{ $t('message.regular.navigation.regularThirdTitle5') }}</h3>
      ...
      <h3
        ...
        class="title"
        name="6"
      >{{ $t('message.regular.navigation.regularThirdTitle6') }}</h3>
      ...
      <h3
        ...
        class="title"
        name="7"
      >{{ $t('message.regular.navigation.regularThirdTitle7') }}</h3>
      <div class="list-circle">
...
export default {
  ...
  data() {
    return {
      ...
      tbodyList: [
        [
          "BTC" + this.$t("message.regular.navigation.regularTitle1"),
          "0.002",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "EOS" + this.$t("message.regular.navigation.regularTitle1"),
          "2",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "ETH" + this.$t("message.regular.navigation.regularTitle1"),
          "0.05",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "LTC" + this.$t("message.regular.navigation.regularTitle1"),
          "0.2",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "XRP" + this.$t("message.regular.navigation.regularTitle1"),
          "40",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "ETC" + this.$t("message.regular.navigation.regularTitle1"),
          "1",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "TRX" + this.$t("message.regular.navigation.regularTitle1"),
          "400",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "BNB" + this.$t("message.regular.navigation.regularTitle1"),
          "0.5",
          "USDT",
          "T+0",
          "24H",
        ...
        [
          "HT" + this.$t("message.regular.navigation.regularTitle1"),
          "5",
          "USDT",
          "T+0",
          "24H",
  ...
  watch: {
    ...
    "$i18n.locale"() {
      ...
      this.tbodyList = [
        ...
        [
          "BCH" + this.$t("message.regular.navigation.regularTitle1"),
          "0.02",
          "USDT",
          "T+0",
          "24H",
  ...
  methods: {
    ...
    scrollFunc1() {
      ...
      if (toTop > height1 && toTop < height2) {
        // console.log(1)
        this.$store.commit("dictionary/SET_NAV", 1);
      } else if (toTop > height2 && toTop < height3) {
        // console.log(2)
        this.$store.commit("dictionary/SET_NAV", 2);
      } else if (toTop > height3 && toTop < height4) {
        // console.log(3)
        this.$store.commit("dictionary/SET_NAV", 3);
      } else if (toTop > height4 && toTop < height5) {
        this.$store.commit("dictionary/SET_NAV", 4);
      } else if (toTop > height5 && toTop < height6) {
        this.$store.commit("dictionary/SET_NAV", 5);
      } else if (toTop > height6 && toTop < height7) {
        this.$store.commit("dictionary/SET_NAV", 6);
      } else if (toTop > height7 && toTop < height7 - 250) {
        this.$store.commit("dictionary/SET_NAV", 6);
      } else if (toTop > height7 - 250) {
        this.$store.commit("dictionary/SET_NAV", 7);
      }
    },
    scrollFunc2() {
